...
def Api_connect():
    Api_Id='AIzaSyArK-z_qAl_1nsJ7iJvn7nGza_l7q-elwM'
...
client=pymongo.MongoClient("mongodb+srv://Javidakthar:guvi123@cluster0.nhgowt8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db=client['Youtube_info']
...
def channels_table(channel_name_s):
    ...
    #inserting mongodb data to  post sql 
...
#Uploading vidos info into posql
...
with st.sidebar:
    ...
    st.write("""
    Building a simple UI with Streamlit, retrieving data from YouTube API, 
    migrating it to an SQL data warehouse, querying the data warehouse with SQL, 
    and displaying the data in the Streamlit app.
""")
